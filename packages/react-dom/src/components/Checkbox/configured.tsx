...
import { Checkbox as CheckboxClear, Checkboxes } from './clear.js'
...
export type CheckboxConfiguredPropsWithRef<TAs extends As = CheckboxDefaultAs> =
  CheckboxConfiguredMainProps<TAs> & AsPropsWithRef<TAs>
...
export const createCheckbox = ({ uinityConfig }: { uinityConfig: UinityConfig }) => {
  const Checkbox: CheckboxConfigured = forwardRefIgnoreTypes(
    ({ variant, color, size, $style = {}, ...restProps }: CheckboxConfiguredPropsWithoutRef, ref: any) => {
